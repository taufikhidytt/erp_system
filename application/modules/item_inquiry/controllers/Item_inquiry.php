...
class Item_inquiry extends Back_Controller
{
    public function __construct()
    {
        ...
        belum_login();
        rules();
        $this->load->model('Item_inquiry_model', 'item_inquiry');
    }
    ...
    public function get_data()
    {
        ...
        // ==========================
        if ($check_gudang == 'true') {
            $query = $this->db->query("CALL SP_REPORT_STOK_ALL()");
        } else {
            $query = $this->db->query("CALL SP_REPORT_STOK_WAREHOUSE(?)", [$warehouse_id]);
        }
    ...
    public function get_columns()
    {
        ...
        $query = $this->db->query("CALL SP_REPORT_STOK_ALL_PIVOT_DYNAMIC()");
        $row = $query->row();
    ...
    public function get_data_kartu_stok()
    {
        ...
        // ==========================
        if ($warehouse_id == "") {
            $query = $this->db->query("CALL SP_REPORT_STOK_KARTU_STOK_ALL(?,?)", [$item, $period]);
        } else {
            $query = $this->db->query("CALL SP_REPORT_STOK_KARTU_STOK(?,?,?)", [$item, $warehouse_id, $period]);
        }
