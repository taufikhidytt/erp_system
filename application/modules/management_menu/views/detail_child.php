                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <?php if($parent){ ?>
                            <li class="breadcrumb-item">
                                <a href="<?= base_url('management_menu/detail/'.base64url_encode($this->encrypt->encode($data->PARENT_ID))) ?>" class="text-decoration-underline"><?= $parent->PROMPT ?></a>
                            </li>
                            <?php } ?>
                        ...
                        <form action="" method="post">
                            <div class="row mb-2">
                                <div class="col-sm-12 text-end">
                                    ...
                                    <a href="<?= site_url('management_menu/add_child/'.base64url_encode($this->encrypt->encode($data->PARENT_ID))) ?>" 
