                                            ...
                                            <?php foreach($servers as $index => $server):
                                                ...
                                                <tr>
                                                    <td class="text-center">
                                                        ...
                                                        <input type="checkbox" name="active_flag[]" class="chk-server" value="Y" <?= set_value("active_flag[$index]","N") == 'Y' ? 'checked' : '' ?>>
                                                    </td>
                                                    ...
                                                    <td class="text-center">
                                                        <input type="checkbox" name="default_server[]" class="default-server" value="Y" <?= set_value("default_server[$index]", 'N') == 'Y' ? 'checked' : '' ?> disabled>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
