                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="full_name" id="full_name" class="form-control <?= form_error('full_name') ? 'is-invalid' : null; ?>" 
                                                    placeholder="Nama Lengkap" value="<?= set_value('full_name',''); ?>">
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select name="group_id" id="group_id" class="select2 form-select<?= form_error('group_id') ? ' is-invalid' : null; ?>"
                                                    ...
                                                    data-selected-id="<?= set_value('group_id','') ?>"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select name="divisi_id" id="divisi_id" class="select2 form-select<?= form_error('divisi_id') ? ' is-invalid' : null; ?>"
                                                    ...
                                                    data-selected-id="<?= set_value('divisi_id','') ?>"
                                                    data-dropdown-parent="body"
                                                    ></select>
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="title" id="title" class="form-control <?= form_error('title') ? 'is-invalid' : null; ?>" 
                                                    placeholder="Jabatan" value="<?= set_value('title',''); ?>">
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="datetime-local" name="start_date" id="start_date" class="form-control <?= form_error('start_date') ? 'is-invalid' : null; ?>" 
                                                    placeholder="Start Date" value="<?= set_value('start_date',''); ?>">
                                            </div>
                                                ...
                                                <?php 
                                                    ...
                                                    foreach ($old_account as $k => $v) { ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <textarea class="form-control form-control-sm border-0 coa-note" name="account_note[]" readonly><?= isset($old_account_note[$k]) ? $old_account_note[$k] : '' ?></textarea>
                                        ...
                                        <table id="tbl-warehouse" class="table mt-3 w-100 table-sm align-top">
                                            ...
                                            <tbody>
                                                <?php 
                                                    ...
                                                    $old_default_warehouse = $this->input->post('default_warehouse') ?? [];
                                                    foreach ($old_warehouses as $k => $v) { ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="checkbox" name="default_warehouse[]" value="Y" class="form-check-input default-warehouse fs-5"<?= set_value('default_warehouse[' . $k . ']','N') == 'Y' ? 'checked' : '' ?>>
                                                            </td>
                                                        </tr>
                                                    <?php }
                                                ?>
...
<script>
    ...
    $(document).on('change', '#group_id', function(){
        ...
        if(group_id && group_id !== '__empty__') {
            $('#loading').show();
            if(xhr){
                xhr.abort();
            }
            ...
            $('#d-menu').html(`<div class="alert alert-dark mb-0" role="alert">
                Pilih group untuk menampilkan menu dan hak akses.
            </div>`);
        }
    });
