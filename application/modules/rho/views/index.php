...
<script>
    $(document).ready(function() {
        var table = $('#table').DataTable({
            ...
            buttons: [{
                ...
                action: function(e, dt, node, config) {
                    window.location.href = "<?= base_url('rho/add') ?>";
                }
            }],
            "autoWidth": false,
            "searching": true,
        ...
        $('#table tbody').on('click', 'td.details-control', function() {
            ...
            var request_qty_id = rowData.request_qty_id;
            ...
            if (row.child.isShown()) {
                ...
                var childTableId = 'child-' + request_qty_id;
