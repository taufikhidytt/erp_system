...
<table class="items-table">
    ...
    <tfoot>
        <tr class="total-row">
            ...
            <td colspan="2" style="text-align:right !important"><?= numb_format($so->TOTAL_AMOUNT) ?></td>
        </tr>
        <tr class="total-row">
            <td colspan="7" style="text-align:right !important">Diskon</td>
            <td colspan="2" style="text-align:right !important"><?= numb_format($so->TOTAL_DISCOUNT) ?></td>
        </tr>
        <tr class="total-row">
            <td colspan="7" style="text-align:right !important">PPN</td>
            <td colspan="2" style="text-align:right !important"><?= numb_format($so->PPN_AMOUNT) ?></td>
        </tr>
        <tr class="total-row">
            <td colspan="7" style="text-align:right !important">GRAND TOTAL</td>
            <td colspan="2" style="text-align:right !important"><?= numb_format($so->TOTAL_NET) ?></td>
        </tr>
    </tfoot>
</table>
