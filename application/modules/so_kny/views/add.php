...
<script>
    ...
    $(document).ready(function() {
        // Inisialisasi plugin input-number
        ...
        tableDetail = $('#table-detail').DataTable({
            ...
            columnDefs: [{
                ...
                { targets: 11, width: "15%", className: "ellipsis text-end", createdCell: function(td) { td.style.fontFamily = 'monospace'; } }, 
        ...
        $("#btnSubmit").on("click", function(e) {
            ...
            $(allRows).find('.chkRow:checked:not(:disabled)').each(function() {
                ...
                let rowNode = tableDetail.row.add([
                    ...
                    <input type="text" class="form-control form-control-sm harga-input edit-mode harga-edit d-none enter-as-tab text-end input-number" name="detail[harga_input][]" value="0.00">`,
                    // harga
                    ...
                    <input type="text" class="form-control form-control-sm diskon-harga edit-mode harga-edit d-none enter-as-tab text-end input-number" name="detail[diskon_harga][]" value="0.00">`,
                    // diskon percen
