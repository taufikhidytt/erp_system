                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="name" id="name" class="form-control <?= form_error('name') ? 'is-invalid' : null; ?>" value="<?= set_value('name','') ?>" placeholder="Enter DB Name">
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="alias" id="alias" class="form-control <?= form_error('alias') ? 'is-invalid' : null; ?>" value="<?= set_value('alias','') ?>" placeholder="Enter DB Alias">
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="hostname" id="hostname" class="form-control <?= form_error('hostname') ? 'is-invalid' : null; ?>" value="<?= set_value('hostname','') ?>" placeholder="Enter Hostname">
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="port" id="port" 
                                                    ...
                                                    class="input-number form-control <?= form_error('port') ? 'is-invalid' : null; ?>" value="<?= set_value('port','') ?>">
                                            </div>
