...
<script>
    $(document).ready(function() {
        var table = $('#table').DataTable({
            ...
            buttons: [{
                ...
                action: function(e, dt, node, config) {
                    window.location.href = "<?= base_url('do_kny/add') ?>";
                }
            }],
            "autoWidth": false,
            "searching": true,
        ...
        $('#table tbody').on('click', 'td.details-control', function() {
            ...
            var inventory_out_id = rowData.inventory_out_id;
            ...
            if (row.child.isShown()) {
                ...
                var childTableId = 'child-' + inventory_out_id;
                ...
                $('#' + $.escapeSelector(childTableId)).DataTable({
                    ...
                    "serverSide": true,
                    "ajax": {
                        "url": "<?= site_url('do_kny/get_detail'); ?>",
                        "type": "POST",
                        "data": {
