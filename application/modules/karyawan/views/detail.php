...
<div class="page-content" data-aos="zoom-in">
    <div class="container-fluid">
        ...
        <form action="" method="post" id="myForm">
            <input type="hidden" name="id" value="<?= base64url_encode($this->encrypt->encode($data->KARYAWAN_ID)); ?>">
            <div class="row">
                <div class="col-12">
                                    ...
                                    <?= button_actions(['insert', 'save',
                                        [
                                            ...
                                            'data-param'   => base64_encode($this->encrypt->encode(json_encode([
                                                'h' => [
                                                    't' => 'KARYAWAN',
                                                    'w' => ['KARYAWAN_ID' => $data->KARYAWAN_ID]
                                                ],
                                                'where' => [
                                                    'TABLE_NAME'    => 'KARYAWAN',
                                                    'ID'      => $data->KARYAWAN_ID
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="nama_depan" id="nama_depan" class="form-control <?= form_error('nama_depan') ? 'is-invalid' : null; ?>"
                                                    placeholder="Nama Depan" value="<?= set_value('nama_depan', $data->FIRST_NAME); ?>">
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="nama_belakang" id="nama_belakang" class="form-control <?= form_error('nama_belakang') ? 'is-invalid' : null; ?>"
                                                    placeholder="Nama Belakang" value="<?= set_value('nama_belakang', $data->LAST_NAME); ?>">
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <select name="bagian" id="bagian" class="form-select select2 <?= form_error('bagian') ? 'is-invalid' : null; ?>"
                                                    ...
                                                    data-selected-id="<?= set_value('bagian', $data->DEPT_ID ?? '') ?>">
                                                </select>
                                            </div>
                                            <input type="hidden" name="program_code" id="program_code" value="<?= set_value('program_code', $data->PROGRAM_CODE1); ?>">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <select name="divisi" id="divisi" class="form-select select2 <?= form_error('divisi') ? 'is-invalid' : null; ?>"
                                                    ...
                                                    data-default="Y"
                                                    data-dropdown-parent="body"
                                                    data-selected-id="<?= set_value('divisi', $data->DIVISI_ID) ?>">
                                                </select>
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <select name="kategori" id="kategori" class="form-select select2 <?= form_error('kategori') ? 'is-invalid' : null; ?>"
                                                    ...
                                                    data-default="Y"
                                                    data-dropdown-parent="body"
                                                    data-selected-id="<?= set_value('kategori', $data->KATEGORI_ID) ?>">
                                                </select>
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <select name="gudang_sales" id="gudang_sales" class="form-select select2 <?= form_error('gudang_sales') ? 'is-invalid' : null; ?>"
                                                    ...
                                                    data-default="Y"
                                                    data-dropdown-parent="body"
                                                    data-selected-id="<?= set_value('gudang_sales', $data->WAREHOUSE_ID) ?>">
                                                </select>
                                            </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="date" name="end_date" id="end_date" class="form-control <?= form_error('end_date') ? 'is-invalid' : null; ?>"
                                                            placeholder="End Date" value="<?= set_value('end_date', $data->END_DATE); ?>">
                                                    </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="type_cu" id="type_cu" class="form-control input-number <?= form_error('type_cu') ? 'is-invalid' : null; ?>"
                                                    placeholder="Type CU" value="<?= set_value('type_cu', $data->TYPE_CUST); ?>">
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="pmc" id="pmc" class="form-control input-number <?= form_error('pmc') ? 'is-invalid' : null; ?>"
                                                    placeholder="PMC" value="<?= set_value('pmc', $data->PMC); ?>">
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="fcp" id="fcp" class="form-control input-number <?= form_error('fcp') ? 'is-invalid' : null; ?>"
                                                    placeholder="FCP" value="<?= set_value('fcp', $data->FCP); ?>">
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="pjt" id="pjt" class="form-control input-number <?= form_error('pjt') ? 'is-invalid' : null; ?>"
                                                    placeholder="PJT" value="<?= set_value('pjt', $data->PROJ_SERV); ?>">
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="acs" id="acs" class="form-control input-number <?= form_error('acs') ? 'is-invalid' : null; ?>"
                                                    placeholder="ACS" value="<?= set_value('acs', $data->ACS_TOOL); ?>">
                                            </div>
                                            <div class="text-danger"><?= form_error('acs') ?></div>
                                        </div>
                                        <div class="mb-3">
                                            <label for="note">Note:</label>
                                            <textarea name="note" id="note" class="form-control <?= form_error('note') ? 'is-invalid' : null; ?>" rows="5" placeholder="Note"><?= set_value('note', $data->DESCRIPTION); ?></textarea>
