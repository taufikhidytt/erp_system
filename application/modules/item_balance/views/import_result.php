                    ...
                    <thead style="background: #3d7bb9; z-index: 10; color: #ffff">
                        <tr>
                            ...
                            <?php foreach ($header as $k => $v) { ?>
                                <th<?= in_array($k,['HPP','QTY_AWAL','SUBTOTAL'])?' class="text-end"':'' ?>><?= $v ?></th>
                            <?php } ?>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?php foreach ($header as $key => $v2) { ?>
                                <td<?= in_array($key,['HPP','QTY_AWAL','SUBTOTAL'])?' class="text-end"':'' ?>>
                                    <?= in_array($key,['HPP','QTY_AWAL','SUBTOTAL'])? numb_format($v[$key]):$v[$key] ?>
                                </td>
                            <?php } ?>
                        </tr>
                        <?php } ?>
