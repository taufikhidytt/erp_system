...
<script>
    $(document).ready(function() {
        ...
        $('#table tbody').on('click', 'td.details-control', function() {
            ...
            var erp_lookup_set_id = rowData.erp_lookup_set_id;
            ...
            if (row.child.isShown()) {
                ...
                var childTableId = 'child-' + erp_lookup_set_id;
                ...
                $('#' + $.escapeSelector(childTableId)).DataTable({
                    ...
                    "serverSide": true,
                    "ajax": {
                        "url": "<?= site_url('lov/get_detail'); ?>",
                        "type": "POST",
                        "data": {
                            erp_lookup_set_id: erp_lookup_set_id
                        }
                    },
                    "columns": [{
                            "data": "no",
