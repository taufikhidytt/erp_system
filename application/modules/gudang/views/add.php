                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="warehouse_name" id="warehouse_name" class="form-control <?= form_error('warehouse_name') ? 'is-invalid' : null; ?>" 
                                                    placeholder="Nama Gudang" value="<?= set_value('warehouse_name',''); ?>" maxlength="20" oninput="this.value = this.value.toUpperCase()">
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea name="description" id="description" class="form-control <?= form_error('description') ? 'is-invalid' : null; ?>" rows="2" placeholder="Deskripsi" maxlength="80" oninput="this.value = this.value.toUpperCase()"><?= set_value('description',''); ?></textarea>
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select name="jenis_id" id="jenis_id" class="form-select select2 <?= form_error('jenis_id') ? 'is-invalid' : null; ?>"
                                                    ...
                                                    data-selected-id="<?= set_value('jenis_id','') ?>"
                                                    >
                                                </select>
                                            </div>
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select name="address_id" id="address_id" class="form-select select2 <?= form_error('address_id') ? 'is-invalid' : null; ?>"
                                                    ...
                                                    data-selected-id="<?= set_value('address_id','') ?>"
                                                    >
                                        ...
                                        <div class="d-flex gap-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="form-check form-switch form-switch-md mb-3" dir="ltr">
                                                    <input type="checkbox" class="form-check-input" id="sales_flag" name="sales_flag" value="Y" <?= set_value('sales_flag', 'N') == 'Y' ? 'checked' : '' ?>>
