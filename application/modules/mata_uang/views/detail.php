<div class="page-content" data-aos="zoom-in">
    <div class="container-fluid">
        ...
        <form action="" method="post" id="myForm">
            <input type="hidden" name="id" value="<?= base64url_encode($this->encrypt->encode($data->MATA_UANG_ID)); ?>">
            <div class="row">
                <div class="col-12">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="mata_uang_code" id="mata_uang_code" class="form-control <?= form_error('mata_uang_code') ? 'is-invalid' : null; ?>" 
                                                    placeholder="KODE" value="<?= set_value('mata_uang_code', $data->MATA_UANG_CODE); ?>" maxlength="10" oninput="this.value = this.value.toUpperCase()">
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="mata_uang_name" id="mata_uang_name" class="form-control <?= form_error('mata_uang_name') ? 'is-invalid' : null; ?>" 
                                                    placeholder="Nama" value="<?= set_value('mata_uang_name', $data->MATA_UANG_NAME); ?>" maxlength="40" oninput="this.value = this.value.toUpperCase()">
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="saldo_awal" id="saldo_awal" class="input-number form-control <?= form_error('saldo_awal') ? 'is-invalid' : null; ?>" 
                                                    placeholder="Kurs Awal" value="<?= set_value('saldo_awal', $data->SALDO_AWAL); ?>">
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="state" id="state" class="form-control <?= form_error('state') ? 'is-invalid' : null; ?>" 
                                                    placeholder="Negara" value="<?= set_value('state', $data->STATE); ?>" maxlength="30">
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="symbol" id="symbol" class="form-control <?= form_error('symbol') ? 'is-invalid' : null; ?>" 
                                                    placeholder="Simbol" value="<?= set_value('symbol', $data->SYMBOL); ?>" maxlength="10">
                                            </div>
