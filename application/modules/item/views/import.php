                ...
                <div class="card rounded-3 p-4" id="card-import-main">
                    ...
                    <div id="state-idle">
                        <div class="text-center py-4">
                            ...
                            <h5 class="fw-semibold mb-1">Import Data Item</h5>
                            <p class="text-muted small mb-4">
                                Download template terlebih dahulu, isi data mulai dari <strong>baris ke-8 dengan maksimal 1rb item</strong>,
                            ...
                            <!-- Form tersembunyi, dipicu oleh tombol -->
                            ...
                            <div class="d-flex justify-content-center gap-2 flex-wrap">
                                ...
                                <a href="<?= base_url($access['url'] . '/template_import') ?>"
...
<script>
    $(document).ready(function () {
        ...
        const URLS = {
            history       : '<?= base_url("item/import_history") ?>',
            upload        : '<?= base_url("item/upload") ?>',
            get_status    : '<?= base_url("item/get_status") ?>',
            finalize      : '<?= base_url("item/finalize_import") ?>',
            download_failed: '<?= base_url("item/download_failed/") ?>',
            cancel        : '<?= base_url("item/import_cancel/") ?>',
        };
