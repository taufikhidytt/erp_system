                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item">
                                <a href="<?= base_url('item') ?>" class="text-decoration-underline"><?= $access['PROMPT'] ?></a>
                            </li>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php 
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    <input type="checkbox" class="chk-default" name="status_satuan_detail[]" <?= $i_status_satuan_detail[$index] == 'Y' ? 'checked' : '' ?> value="Y">
