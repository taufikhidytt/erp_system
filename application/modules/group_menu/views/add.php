                        ...
                        <div class="card-body border-top">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control <?= form_error('name') ? 'is-invalid' : null; ?>" placeholder="Enter Group Name" value="<?= $this->input->post('name') ?? ''; ?>">
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <textarea name="note" id="note" class="form-control <?= form_error('note') ? 'is-invalid' : null; ?>" 
                                        placeholder="Enter Group Name"><?= $this->input->post('note') ?? ''; ?></textarea>
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <div class="form-check form-switch mb-3" dir="ltr">
                                        <input type="checkbox" name="active_flag" class="form-check-input" id="active_flag" <?= set_value('active_flag', '') === 'N' ? '' : 'checked' ?>>
