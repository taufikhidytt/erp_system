...
class Sts_model extends CI_Model
{
    ...
    public function count_detail_by_pr_id($tag_konsi_id)
    {
    ...
    public function getTagKonsiId($id)
    {
        $this->db->from('tag_konsi');
        $this->db->where('tag_konsi.TAG_KONSI_ID', $id);
        return $this->db->get();
    }
    ...
    public function delete($id)
    {
        ...
        $this->db->delete('tag_konsi_detail');
