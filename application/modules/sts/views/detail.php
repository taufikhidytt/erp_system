                                                    ...
                                                    foreach ($dataDetail->result() as $dd): ?>
                                                        ...
                                                        <tr class="tr-height-30">
                                                            ...
                                                            <td class="ellipsis text-end">
                                                                ...
                                                                <input type="number" class="form-control form-control-sm qty auto-width edit-mode qty-edit d-none enter-as-tab" name="detail[jumlah][]" data-balance="<?= rtrim(rtrim($this->input->post('detail[jumlah][]') ?? rtrim(rtrim($balance, '0'), '.'), '0'), '.'); ?>" data-tag_konsi_detail_id="<?= $this->encrypt->encode('TAG_KONSI_DETAIL_ID') ?>" data-value_old="<?= rtrim(rtrim($dd->ENTERED_QTY, '0'), '.') ?>" value="<?= rtrim(rtrim($this->input->post('detail[jumlah][]') ?? rtrim(rtrim($dd->ENTERED_QTY, '0'), '.'), '0'), '.'); ?>">
                                                            </td>
