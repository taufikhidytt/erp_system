<div class="section-title">
    <h1 class="report-title"><?= strtoupper('Sent to Site') ?></h1>
</div>
    ...
    <tr>
        <td class="info-card">
            <table width="100%" class="info-row">
                <tr><td>No Transaksi</td><td class="info-dots">:</td><td><?= $sts->DOCUMENT_NO ?></td></tr>
                <tr><td>Main Storage</td><td class="info-dots">:</td><td><?= $sts->WAREHOUSE_NAME ?? '-' ?></td></tr>
                <tr><td>Site Storage</td><td class="info-dots">:</td><td><?= $sts->TO_WAREHOUSE_NAME ?? '-' ?></td></tr>
            </table>
        </td>
        <td width="4%"></td>
        <td class="info-card">
            <table width="100%" class="info-row">
                <tr><td>Tanggal</td><td class="info-dots">:</td><td><?= date('d-m-Y H:i', strtotime($sts->DOCUMENT_DATE)) ?></td></tr>
                <tr><td>No Referensi</td><td class="info-dots">:</td><td><?= $sts->DOCUMENT_REFF_NO ?? '-' ?></td></tr>
            </table>
        </td>
    </tr>
